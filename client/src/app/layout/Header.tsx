...
function Header() {
    const {basket} = useAppSelector(state => state.persist);
            ...
            <nav className="flex items-center justify-between py-6 container mx-auto">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <div className={"relative"}>
                        ...
                        {itemCount !== 0 && 
                            <div className={"bg-primary absolute -top-3 -right-3 text-white w-[15px] h-[15px] box-content p-[1px] text-xs rounded grid place-items-center"}>
                                {itemCount}
                            </div>
                        }
                    </div>
                                ...
                                <div
                                    ...
                                    <div className={"relative gap-8 bg-white p-4"}>
                                        <div className="flex flex-col w-full">
                                            <Link to={"/"}
                                                  className={"flex gap-5 items-center hover:bg-gray-50 p-3 rounded-lg"}>
